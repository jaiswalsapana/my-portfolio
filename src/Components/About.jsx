...
import Common from '../All common/Common'
import {NavLink} from 'react-router-dom'
import {Link} from 'react-router-dom'
import local from '../assets/Images/local.png';
import Progress from '../All common/Progress';
import Lastfoot from '../All common/Lastfoot';
...
const About = (props) => {
  ...
  return (
    ...
    <Common name='I have Experience in all' name2=' Frontend Technologies' visit='/contact' imgsrc={local} btname='Contact'/>
    <Progress/>
    <Lastfoot/>
    <Footer/>
